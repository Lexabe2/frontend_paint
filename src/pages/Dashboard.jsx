      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-8">
        ...
        <AnimatePresence mode="wait">
          {activeTab && (
            ...
            >
              {/* Tab Header */}
              <div className={`bg-gradient-to-r ${tabConfig[activeTab].bgColor} rounded-2xl p-6 border border-gray-100`}>
                <div className="flex items-center space-x-3">
                  <div className={`p-3 bg-gradient-to-r ${tabConfig[activeTab].color} rounded-2xl shadow-lg`}>
