    ...
    <div className="min-h-screen bg-slate-50 pb-safe-bottom">
      <div className="bg-white border-b border-slate-200 sticky top-0 z-20 safe-top">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4">
          ...
          <div className={`${showMobileFilters ? 'flex' : 'hidden md:flex'} flex-col md:flex-row items-stretch md:items-center gap-2 md:gap-3`}>
      ...
      {selectedIds.length > 0 && (
        <div className="bg-blue-50 border-b border-blue-200">
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4">
            <div className="flex items-center justify-between mb-3 md:mb-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-2 md:px-3 py-1.5 text-xs md:text-sm bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-all font-medium"
                >
            ...
            <div className={`${showBulkActions ? 'grid' : 'hidden md:grid'} grid-cols-1 lg:grid-cols-2 gap-2 md:gap-3`}>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-6">
        <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
          <div className="px-3 md:px-4 py-2 md:py-3 border-b border-slate-200 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <input
                ...
                placeholder="Кол-во"
                className="w-16 md:w-20 px-2 py-1 text-xs md:text-sm bg-slate-50 border border-slate-200 rounded focus:outline-none focus:ring-2 focus:ring-slate-900 transition-all"
              />
              <button
                onClick={selectFirstN}
                disabled={!selectCount}
                className="px-2 md:px-3 py-1 text-xs md:text-sm bg-slate-900 text-white rounded hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium whitespace-nowrap"
              >
                Выбрать
              </button>
            </div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 md:gap-2 px-2 md:px-3 py-1 text-xs md:text-sm text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded transition-all whitespace-nowrap"
            >
              {allSelected ? (
                <>
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-lg font-bold text-slate-900">#{sn.number}</span>
                      ...
                      <div className="space-y-2 text-sm">
                        {sn.act_number && (
                          <div className="flex items-start">
                            <span className="text-slate-500 min-w-[100px]">Номер акта:</span>
                            <span className="text-slate-900 font-medium">{sn.act_number}</span>
                          </div>
                        )}
                        {sn.issue_date && (
                          <div className="flex items-start">
                            <span className="text-slate-500 min-w-[100px]">Выставлен:</span>
                            <span className="text-slate-900">{sn.issue_date}</span>
                          </div>
                        )}
                        {sn.signing_date && (
                          <div className="flex items-start">
                            <span className="text-slate-500 min-w-[100px]">Подписан:</span>
                            <span className="text-slate-900">{sn.signing_date}</span>
                          </div>
                        )}
                        {sn.payment_to_yakovlev && (
                          <div className="flex items-start">
                            <span className="text-slate-500 min-w-[100px]">Оплата:</span>
                            <span className="text-slate-900 font-medium">{sn.payment_to_yakovlev}</span>
                          </div>
                        )}
                        {sn.atm?.model && (
                          <div className="flex items-start">
                            <span className="text-slate-500 min-w-[100px]">Модель:</span>
                            <span className="text-slate-900">{sn.atm.model}</span>
                          </div>
                        )}
                        {sn.atm?.status && (
                          <div className="flex items-start">
                            <span className="text-slate-500 min-w-[100px]">ATM статус:</span>
                            <span className="text-slate-900">{sn.atm.status}</span>
                          </div>
                        )}
                        {sn.atm?.paint_number && (
                          <div className="flex items-start">
                            <span className="text-slate-500 min-w-[100px]">Номер счета:</span>
                            <span className="text-slate-900">{sn.atm.paint_number}</span>
                          </div>
                        )}
                        <div className="flex items-start">
                          <span className="text-slate-500 min-w-[100px]">Счет оплачен:</span>
                          {sn.atm?.invoice_paid ? (
