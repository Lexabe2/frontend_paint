    ...
    return (
        <div className="max-w-7xl mx-auto p-6 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                ...
                {showFilters && (
                    <div
                        className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                        {/* Status Filter */}
                                ...
                                <tr key={req.request_id} className="hover:bg-gray-50 transition-colors duration-150">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <span
                                                className="font-mono text-gray-900 font-medium">#{req.request_id}</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                        ...
                        {getStatusIcon(req.status)}
                          <span className="ml-2">{req.status}</span>
                                    ...
                                    <td className="px-6 py-4">
                                        <button
                                            type="button"
                                            onClick={() => navigate(`/status_req/${req.request_id}`)} // ← переход
                        ...
                        {filteredRequests.map((req, index) => (
                            <div key={req.request_id}
                                ...
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <span
                                        className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${getStatusColor(req.status)}`}>
                    {getStatusIcon(req.status)}
