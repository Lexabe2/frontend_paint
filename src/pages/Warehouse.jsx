...
export default function Warehouse() {
        ...
        api.post("/warehouse/add/", {
            ...
            .catch((err) => {
                ...
                if (err.response && err.response.data && err.response.data.error) {
                    alert(err.response.data.error); // показываем только текст ошибки
                } else {
    ...
    const handlePlaceChange = (e) => {
        ...
        if (value.length > 5) value = value.slice(0, 5) + "-" + value.slice(5, 6);
        setNewPlace(value.slice(0, 8)); // ограничиваем длину до xx-xx-xx
    };
        ...
        <div className="min-h-screen bg-white">
                                                ...
                                                <div key={h.id} className="flex items-start space-x-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center space-x-2 text-sm">
                                                            <span
                                                                className="font-medium text-gray-900">{h.action}</span>
            ...
            {showAddForm && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div
                        className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl transform transition-all duration-300">
