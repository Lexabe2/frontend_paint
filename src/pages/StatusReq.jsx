            ...
            <div
                ...
                <div className="flex flex-col items-center gap-4">
                    <div className="relative">
                        ...
                        <div
                            className="absolute inset-0 w-16 h-16 border-4 border-transparent border-t-blue-400 rounded-full animate-ping opacity-20"></div>
                    </div>
    ...
    if (!requestData) {
        return (
            <div
                ...
                <div
                    className="bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl p-12 border border-slate-200 text-center">
    ...
    return (
        <div className="min-h-screen from-slate-50 via-blue-50 to-slate-100">
            <div className="sticky top-0 z-20 bg-white/80 backdrop-blur-xl border-b border-slate-200 shadow-lg">
                    ...
                    <div className="flex items-start gap-4 mb-5">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2 flex-wrap">
                                ...
                                <div
                                    className={`flex items-center gap-2 px-4 py-2 ${currentStatusConfig.color} rounded-xl shadow-sm border`}>
                ...
                <span className="text-sm text-slate-600 flex items-center gap-2">
                  ...
                  <span className="font-medium text-slate-700">{requestData.atm_list_req.length} банкоматов</span>
                    ...
                    {error && (
                        <div
                            className="flex items-center gap-3 p-4 bg-red-50 border border-red-200 text-red-700 rounded-xl mb-5">
                    ...
                    <div
                        className="flex items-center gap-3 flex-wrap bg-gradient-to-r from-slate-50 to-blue-50 rounded-xl p-4 border border-slate-200 shadow-sm">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="relative status-dropdown">
                                ...
                                {isStatusDropdownOpen && (
                                    <div
                                        className="absolute top-full left-0 mt-2 w-full bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden z-30">
            ...
            <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
                <div
                    className="bg-white/80 backdrop-blur-xl shadow-xl rounded-3xl border border-slate-200 overflow-hidden">
                    <div className="p-6">
                        <div className="flex items-center justify-between mb-5">
                            <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-3">
                                ...
                                Банкоматы с заявкой
                                <span
                                    className="text-base font-normal text-slate-500 bg-slate-100 px-3 py-1 rounded-lg border border-slate-200">
                            ...
                            <div className="overflow-hidden rounded-xl border border-slate-200">
                                <table className="w-full">
                                    ...
                                    <tr className="bg-gradient-to-r from-slate-100 to-slate-50">
                                        <th className="text-left p-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Серийный
                                            номер
                                        </th>
                                        <th className="text-left p-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Дата
                                            принятия
                                        </th>
                                    ...
                                    {requestData.atm_list_req.map((atm, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-4">
                          <span
                              className="px-3 py-1.5 bg-slate-100 text-slate-700 rounded-lg text-sm font-semibold border border-slate-200">
                            {atm.pallet}
                          </span>
                                            </td>
                                        </tr>
                ...
                <div
                  ...
                  {filteredAtms.length} из {requestData.atm_list_not_req.length}
                    ...
                    {[searchSN, filterFrom, filterTo].filter(Boolean).length}
                        ...
                        {showFilters && (
                            <div
                                className="mb-5 p-5 bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl border border-slate-200">
