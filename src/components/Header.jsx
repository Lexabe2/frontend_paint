...
export default function ResponsiveHeader() {
    ...
    const adminRoles = ["admin", "storekeeper", "admin_paint"]
    const isAnyAdmin = adminRoles.includes(user?.role)
                                        ...
                                        {isNavigationOpen && (
                                            ...
                                            >
                                                ...
                                                <div className="relative z-10">
                                                    {/* Group Tabs */}
                                                    {isAnyAdmin && Object.keys(availableGroups).length > 1 && (
                            ...
                            <motion.button
                                ...
                                className={`${
                                    isMobile
                                        ...
                                        : "md:hidden p-2 text-gray-400 hover:text-white hover:bg-gray-700/50 rounded-xl border border-transparent hover:border-gray-600/30"
